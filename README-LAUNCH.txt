Apex Power Systems Launch-Ready Static Site V1

Open:
- dev-index.html for local navigation
...
Resources page:
- Large document downloads were removed/replaced with Request Documents links to keep the website lightweight and avoid broken download references.
